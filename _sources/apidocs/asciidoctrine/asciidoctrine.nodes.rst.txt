...
.. list-table::
   ...
   * - :py:obj:`BlockNode <asciidoctrine.nodes.BlockNode>`
     - .. autodoc2-docstring:: asciidoctrine.nodes.BlockNode
          :parser: sphinx_asciidoctrine.parser
          :summary:
   * - :py:obj:`Docinfo <asciidoctrine.nodes.Docinfo>`
     - .. autodoc2-docstring:: asciidoctrine.nodes.Docinfo
          :parser: sphinx_asciidoctrine.parser
          :summary:
...
.. py:class:: Docinfo(head_content: str = '', footer_content: str = '')
   ...
   .. autodoc2-docstring:: asciidoctrine.nodes.Docinfo.__init__
      :parser: sphinx_asciidoctrine.parser

   .. py:attribute:: _should_serialize_attributes
      :canonical: asciidoctrine.nodes.Docinfo._should_serialize_attributes
      :value: False
