...
.. py:class:: FileProvider
   ...
   .. py:method:: read_text(path: str | pathlib.Path) -> str
   ...
   .. py:method:: exists(path: str | pathlib.Path) -> bool
   ...
   .. py:method:: is_file(path: str | pathlib.Path) -> bool
   ...
   .. py:method:: resolve_path(path: str | pathlib.Path, base_dir: str | pathlib.Path | None = None) -> str
   ...
   .. py:method:: find_files(pattern: str = '*.adoc', base_dir: str | pathlib.Path | None = None) -> list[str]
...
.. py:class:: FsLoader(base_dir: str | pathlib.Path | None = None, safe_mode: bool | int = True)
...
.. py:class:: MemoryLoader(files: dict[str, str] | None = None, base_dir: str = '/workspace', safe_mode: bool | int = True)
   ...
   .. py:method:: _normalize_posix_path(path: str | pathlib.Path) -> str
   ...
   .. py:method:: put(path: str | pathlib.Path, content: str) -> None
