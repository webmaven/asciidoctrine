...
PyPI Package:: https://pypi.org/project/asciidoctrine/[asciidoctrine on PyPI]
GitHub Repository:: https://github.com/webmaven/asciidoctrine[webmaven/asciidoctrine]
Issue Tracker:: https://github.com/webmaven/asciidoctrine/issues[GitHub Issue Tracker]
License:: Distributed under the https://github.com/webmaven/asciidoctrine/blob/main/LICENSE[Apache License 2.0]
