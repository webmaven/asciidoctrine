...
=== Fixed
* **Malformed Bullet-Prefixed Bold Description List Terms (Issue #94)**:
  - Strict parsing now rejects malformed terms such as `* **Term**:: definition` with a precise `AsciiDocSyntaxError` instead of silently retaining a stray asterisk in rendered output.
