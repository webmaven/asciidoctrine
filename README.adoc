...
This project's documentation is authored entirely in AsciiDoc and compiled using Sphinx along with our own self-hosted `asciidoctrine.sphinx_ext` plugin!
